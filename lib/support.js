 ...
 * type - The expected type
 */
function validateObject(objects, type) {
  var obj;
 ...
 */
module.exports.validateVector = function() {
  validateObject(arguments, VectorTypeAsString);
};
 ...
 */
module.exports.validateMatrix = function() {
  validateObject(arguments, MatrixTypeAsString);
};
 ...
 */
module.exports.validateArray = function() {
  validateObject(arguments, ArrayTypeAsString);
};
...
module.exports.validateNumeric = function() {
  for ( var i = 0; i < arguments.length; i++) {
...
module.exports.validateNull = function() {
  for ( var i = 0; i < arguments.length; i++) {
...
module.exports.isEmpty = function(input) {
  ...
  if(this.isVector(input)) {
    ...
    if (input.cols() > 0 && input.rows() > 0) result = false;
...
module.exports.validateEmpty = function() {
  for ( var i = 0; i < arguments.length; i++) {
